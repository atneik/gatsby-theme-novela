...
- This is what early-stage, no-playbook product work looks like — building the tools to test the thing before the thing exists.
- Design and clinical research can be the same work — not parallel tracks, but one process informing the other.
- The right simulation unlocks everything — hardware constraints don't have to block UX progress.
- Low vision design is a masterclass in simplicity — if it works for this population, it works for everyone.
